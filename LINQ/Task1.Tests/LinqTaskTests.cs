...
namespace Task1.Tests
{
    ...
    public class Tests
    {
        ...
        [TestCase(800, ExpectedResult = 4)] // I changed it because from the data source there is 4 clients that the sum of his orders are more than 800
        [TestCase(0, ExpectedResult = 6)]
        [TestCase(-1, ExpectedResult = 10)] //All ten customers have orders wich sum is more than -1
        [TestCase(1, ExpectedResult = 5)]
